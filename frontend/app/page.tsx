...
import { Stethoscope, Mic, Image, Shield, Activity, FileText, ChevronRight, Sparkles, BarChart3, Brain, Clock, Download } from "lucide-react"
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3, duration: 0.7 }} className="relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-sky-500/20 border border-border/40">
                  <video
                    autoPlay
                    loop
                    muted
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="glass-card rounded-xl px-4 py-3">
                      ...
                      <p className="text-xs text-muted-foreground">A quick demo of AI Skin Specialist</p>
                    </div>
                  </div>
                </div>
              </motion.div>
